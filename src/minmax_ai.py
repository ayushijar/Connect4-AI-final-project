...
def minimax(game_board, depth, alpha, beta, maximizing_player, no_of_nodes_explored, pruned_nodes):
    ...
    if isTerminal := is_terminal_node(game_board):
        ...
        return (None, score_position(game_board, AI_PIECE), no_of_nodes_explored, pruned_nodes)
    ...
    if maximizing_player:
        ...
        for col in valid_locations:
            ...
            new_score = minimax(temp_game_board, depth - 1, alpha, beta, False,no_of_nodes_explored, pruned_nodes)[1]
    ...
    # Minimizing player
        ...
        for col in valid_locations:
            ...
            no_of_nodes_explored+=1
            new_score = minimax(temp_game_board, depth - 1, alpha, beta, True,no_of_nodes_explored,pruned_nodes)[1]
